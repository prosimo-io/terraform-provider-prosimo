...
func (c *api_client) AppOffboarding_Force_DeleteRequest(ctx context.Context, deleteEndpoint string) (*ResourcePostResponseData, error) {

	u, err := url.Parse(deleteEndpoint)
	if err != nil {
